...
4. In order to run trading bot on Mac, run this in Tradebot directory "./tradebot" (If it needs the admin permission, you can run "sudo ./tradebot")
   In Win, change the filename "tradebot" into "tradebot.exe" and run "tradebot.exe"
